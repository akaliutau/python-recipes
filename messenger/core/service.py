...
from .bridge.redis_dep import MessageStore
from .bridge.jinja2_dep import Jinja2


class MessageService:

    name = 'nameko_message_service'
...
class WebServer:
    ...
    name = 'web_server'
    message_service = RpcProxy('nameko_message_service')
    jinja = Jinja2()
