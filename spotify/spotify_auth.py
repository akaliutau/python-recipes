...
from .jukebox.core import read_config
from .jukebox.core import BadRequestError
from .jukebox.auth import Authorization
from .jukebox.auth import get_auth_key
...
def callback():
    ...
    with open('.jukebox', mode='w', encoding='utf-8') as file:
